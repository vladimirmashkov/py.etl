DROP TABLE IF EXISTS temp_sd.S2_video_learningVideo CASCADE;
CREATE TABLE "temp_sd".S2_video_learningVideo (
	id int8 NOT NULL,
    ...
    CONSTRAINT PK_temp_sd_S2_video_learningVideo PRIMARY KEY (id)
);