DROP TABLE IF EXISTS temp_sd.s1_video_learningVideo CASCADE;
CREATE TABLE "temp_sd".s1_video_learningVideo (
	id int8 NOT NULL,
    ...
    CONSTRAINT PK_temp_sd_s1_video_learningVideo PRIMARY KEY (id)
);